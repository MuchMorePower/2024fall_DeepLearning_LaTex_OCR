...
def evaluateTest(val_loader, model, criterion, index_word_map, word_map, beam_size=10, max_caption_length=50, epoch=0):
    ...
    with torch.no_grad():  # 禁用梯度计算
            ...
            for i, (imgs, caps, caplens) in it:
               ...
               # 将词索引转换为单词
                ...
                for token_id in best_seq:
                    ...
                    if token_id == word_map["<pad>"] or token_id == word_map["<start>"]:
                        continue
        ...
        with open("戴运_邓杨凯_黄劲恒_张丁文_model1_pred_v3.txt", "w", encoding="utf-8") as f:
